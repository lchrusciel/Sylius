                    ...
                    ->children()
                        ->arrayNode('import_profile')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ImportExportBundle\Controller\ImportExportController')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\ImportExportBundle\Form\Type\ImportType')->end()
                            ->end()
                        ->end()
                        ->arrayNode('import_job')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ImportExportBundle\Controller\ResourceController')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->end()
                            ->end()
                        ->end()
                        ->arrayNode('export_profile')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ImportExportBundle\Controller\ImportExportController')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\ImportExportBundle\Form\Type\ExportType')->end()
                            ->end()
                        ->end()
                        ->arrayNode('export_job')
                            ->addDefaultsIfNotSet()
